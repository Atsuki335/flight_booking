...
class FlightBookingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [FlightInfo(), TicketList()]),
    );
  }
}
...
class _AirportName extends StatelessWidget {
  ...
  const _AirportName(
      {Key? key, required this.shortName, required this.fullName})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(52 / 2), //四角 ⇨ 丸
      ),
...
class _TicketShapeBorder extends ShapeBorder {
  ...
  Path getInnerPath(Rect rect, {TextDirection? textDirection}) {
    return getOuterPath(rect.deflate(width!), textDirection: textDirection);
  }
    ...
    return Path()
      ..addPath(
          Path()
            ..moveTo(r, 0)
            ..lineTo(wl - rs, 0)
            ..arcToPoint(Offset(wl + rs, 0),
                radius: Radius.circular(rs), clockwise: false)
            ..lineTo(w - r, 0)
            ..arcToPoint(Offset(w, r), radius: Radius.circular(r))
            ..lineTo(w, h - rs)
            ..arcToPoint(Offset(w - r, h), radius: Radius.circular(r))
            ..lineTo(wl + rs, h)
            ..arcToPoint(Offset(wl - rs, h),
                radius: Radius.circular(rs), clockwise: false)
            ..lineTo(r, h)
  ...
  void paint(Canvas canvas, Rect rect, {TextDirection? textDirection}) {
    ...
    canvas.drawPath(
        getOuterPath(rect.deflate(width! / 2.0), textDirection: textDirection),
        paint);
  }
}
...
class _Ticket extends StatelessWidget {
  ...
  const _Ticket({Key? key, required this.image}) : super(key: key);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            '04:25 pm',
                            style:
                                TextStyle(color: kColorTextDark, fontSize: 18),
                          )
                        ],
                      ),
                      Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                'Tickets',
                style: TextStyle(color: kColorTextDark, fontSize: 18),
              ),
        ...
        Expanded(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                _Ticket(image: Image.network(kSingaporeLogoUrl)),
                SizedBox(height: 8),
                _Ticket(
